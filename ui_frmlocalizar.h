/********************************************************************************
** Form generated from reading ui file 'frmlocalizar.ui'
**
...
#ifndef UI_FRMLOCALIZAR_H
#define UI_FRMLOCALIZAR_H
...
public:
    ...
    label->setText(QApplication::translate("Form", "Digite Um Nome a Ser Procurado", 0, QApplication::UnicodeUTF8));
